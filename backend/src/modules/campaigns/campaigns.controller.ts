...
export class CampaignsController {
  ...
  createEmail(@Body() dto: CreateEmailCampaignDto, @CurrentUser() actor: AuthenticatedUser) {
  ...
  deleteEmail(@Param('id') id: string, @CurrentUser() actor: AuthenticatedUser) {
  ...
  @Post('sms')
  @Permissions(PERMISSIONS.CAMPAIGN.CREATE)
  createSms(@Body() dto: CreateSmsCampaignDto, @CurrentUser() actor: AuthenticatedUser) {
  ...
  @Post('warmup')
  @Permissions(PERMISSIONS.CAMPAIGN.CREATE)
  createWarmup(@Body() dto: CreateWarmupProfileDto, @CurrentUser() actor: AuthenticatedUser) {
  ...
  createFunnel(@Body() dto: CreateFunnelDto, @CurrentUser() actor: AuthenticatedUser) {
  ...
  deleteFunnel(@Param('id') id: string, @CurrentUser() actor: AuthenticatedUser) {
